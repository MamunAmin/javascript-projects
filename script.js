...
for(let i=0; i<54; i++)
{
	...
	image[i].src = "images/slider/" + (i + 1) + ".jpg";
...
function imageFrameGenerator() {
    ...
    content[0].style.height = (imageOnHeight*imageSize) - 0 + "px";
